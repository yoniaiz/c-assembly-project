assembly: ofiles/main.o ofiles/helpers.o ofiles/file_handler.o ofiles/messages.o ofiles/initializers.o ofiles/assembly_compiler.o ofiles/first_loop.o
	gcc -g -Wall -pedantic -ansi ofiles/main.o ofiles/helpers.o ofiles/file_handler.o ofiles/initializers.o ofiles/messages.o ofiles/assembly_compiler.o ofiles/first_loop.o -o assembly -lm
